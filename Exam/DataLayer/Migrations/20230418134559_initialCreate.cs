        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThreeDays_Grade = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThreeDays_Days = table.Column<int>(type: "int", nullable: true),
                    ThreeDays_DateFrom = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ThreeDays_DateTo = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Documents", x => x.EntryNumber);
                    table.ForeignKey(
                        name: "FK_Documents_AspNetUsers_ReceiverId",
